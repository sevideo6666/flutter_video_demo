...
class _VideoInfoState extends State<VideoInfo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        decoration: !_platArea
            ? BoxDecoration(
                gradient: LinearGradient(colors: [
                Colors.indigo.withOpacity(0.9),
                Colors.indigoAccent.withOpacity(0.9),
              ], begin: FractionalOffset(0.0, 0.4), end: Alignment.centerRight))
                    ...
                    child: Column(
                      children: [
                        Container(
                          height: 100,
                          padding:
                              EdgeInsets.only(top: 50, left: 30, right: 50),
                          child: Row(
                            children: [
                              InkWell(
                                onTap: () {
  ...
  _onTapVideo(int index) {
    final controller = VideoPlayerController.network(info[index]["sources"]);
          ...
          FloatingActionButton(
            ...
            onPressed: () async {
              ...
              if (index <= info.length - 1) {
                ...
                Get.snackbar("Video", "No more get video");
              }
            },
            child: Icon(
              Icons.fast_forward,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage(info[index]["thumb"]))),
              ),
              SizedBox(
                width: 10,
              ),
